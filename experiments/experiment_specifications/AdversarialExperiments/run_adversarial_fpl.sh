...
run_experiment() {
    ...
    echo "fpl_adversarial,TentMapDataset,3.2,$1,$rounds,$averages,$delta,$out_tent,0.9,0.2" >>$header
    echo "fpl_adversarial,DuellingDataset,3.2,$1,$rounds,$averages,$delta,$out_duelling,0.9,0.2" >>$header
    (
