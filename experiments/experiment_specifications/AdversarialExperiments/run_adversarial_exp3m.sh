...
run_experiment() {
  ...
  echo "adversarial_exp3m,stochastically_constrained_adversarial,3.2,$1,$2,$rounds,$averages,$delta,$out" >>$header
  echo "adversarial_exp3m,mod2,3.2,$1,$2,$rounds,$averages,$delta,$out_mod2" >>$header
  echo "adversarial_exp3m,TentMapDataset,3.2,$1,$2,$rounds,$averages,$delta,$out_tent" >>$header
  #echo "adversarial_exp3m,DuellingDataset,3.2,$1,$2,$rounds,$averages,$delta,$out_duelling" >>$header
