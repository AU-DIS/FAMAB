#!/usr/bin/bash
rm *.csv
./cmake-build-odin/benchmark_bandits --benchmark_out=raw_out.csv --benchmark_out_format=csv
...
python3 plotting/benchmark.py sample.csv ../tmp/sample.png
python3 plotting/benchmark.py update.csv ../tmp/update.png