...
BENCHMARK(benchmark_qbl)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_qbl_sample)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_qbl_update)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);

BENCHMARK(benchmark_fpl)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_fpl_sample)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_fpl_update)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);

BENCHMARK(benchmark_fpl_toplog)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
...
BENCHMARK(benchmark_fpl_hashing)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_fpl_hashing_sample)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_fpl_hashing_update)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);

BENCHMARK(benchmark_exp3)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_exp3_sample)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_exp3_update)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
...
BENCHMARK(benchmark_exp3_heap)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_exp3_heap_sample)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
BENCHMARK(benchmark_exp3_heap_update)->Arg(100)->Arg(1000)->Arg(10000)->Arg(100000)->Threads(8);
