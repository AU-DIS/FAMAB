...
ax1.plot(df_1['T'], df_1['average_divided_by_promise'], marker='o', color='#070')
ax1.plot(df_2['T'], df_2['average_divided_by_promise'], marker='o', color='#292')
ax1.plot(df_3['T'], df_3['average_divided_by_promise'], marker='o', color='#4B4')
ax1.plot(df_4['T'], df_4['average_divided_by_promise'], marker='o', color='#6D6')
ax1.plot(df_5['T'], df_5['average_divided_by_promise'], marker='o', color='#8F8')
